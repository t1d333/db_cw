...
\begin{listing}[H]
	...
	\inputminted[style=bw, frame=single,fontsize = \footnotesize, linenos=, xleftmargin = 1.5em]{golang}{./listings/consumer.go}
\end{listing}

\begin{listing}[H]
	\caption{Запуск в отдельном потоке функции по загрузке накопленных сообщений}
	\label{lst:bulk_worker}
	\inputminted[style=bw, frame=single,fontsize = \footnotesize, linenos=, xleftmargin = 1.5em]{golang}{./listings/bulk_worker.go}
\end{listing}
